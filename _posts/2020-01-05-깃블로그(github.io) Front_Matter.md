...
![post_listig.html의 일부분 ](/img/metadata/ex3.PNG){: margin-top="30px" margin-bottom="30px" margin-left="0px";}
...
![지킬 공식사이트 참조 ](/img/metadata/ex5.PNG){: margin-top="30px" margin-bottom="30px" margin-left="0px";}
`지킬 공식사이트 참조`

## 결과확인
![styles 속성을 준 결과물 ](/img/metadata/ex4.PNG){: margin-top="30px" margin-bottom="30px" margin-left="0px";}
(:
