...
![post_listig.html의 일부분 ](/img/metadata/ex3.PNG){: style="margin-top:30px; margin-bottom:30px; margin-left:"0px!important"}
...
![지킬 공식사이트 참조 ](/img/metadata/ex5.PNG){: style="margin-top:30px; margin-bottom:30px; margin-left:"0px!important"}
`지킬 공식사이트 참조`
